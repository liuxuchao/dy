...
class Xss
{
     ...
     * 允许的style属性
     */
    protected $allowedStyleProperties = [];
    
    /**
     * 允许的style域名
     */
    protected $allowedStyleDomain = [];
     ...
     */
    public function filter($string, $allowedTags = [], $allowedStyleProperties = [])
    {
        //非UTF8编码直接置空
    ...
    public function attributes($attributes, $elem = '')
    {
        ...
        //执行属性的清理
        $tag = isset($this->allowedTags[$elem]) ? $this->allowedTags[$elem] : [];

    ...
    public function show($url = "", $total = 0, $perPage = 10, $pageBarNum = 10, $mode = 1)
    {
        ...
        switch ($mode) {
            case 1:
                ...
                return $pager = ['page_first' => $this->firstPage(), 'page_prev' => $this->prePage(), 'page_next' => $this->nextPage(), 'page_last' => $this->lastPage(), 'page_number' => $this->showselect(), 'page' => $this->nowIndex, 'page_count' => $this->totalPage, 'count' => $total];

...
function get_activity_info($size, $page)
{
    ...
    foreach ($res as $row) {
        ...
        $arr[$row['act_id']]['url'] = url('activity/index/goods_list', ['id' => $row['act_id']]);
 ...
 */
function get_activity_goods($filter = ['goods_ids' => '', 'cat_ids' => '', 'brand_ids' => '', 'user_id' => 0], $warehouse_id, $area_id, $page = 1, $size = 4,$area_city = 0)
{
    $leftJoin = '';

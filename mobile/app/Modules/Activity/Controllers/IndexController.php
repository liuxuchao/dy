...
class IndexController extends FrontendController
{
    ...
    public function actionIndex()
    {
        ...
        foreach ($res as $row) {
            ...
            $row['status'] = get_status($row['start_time'], $row['end_time']); // 0 未开始, 1 正在进行, 2 已结束
    ...
    public function actionGoods()
    {
        if (IS_AJAX) {
            ...
            if (!empty($id)) {
                ...
                cookie('other_area_id ', $other_area_id);
                ...
                $goods_list = get_activity_goods($filter, $region_id, $area_id, $page, $size,$other_area_id);

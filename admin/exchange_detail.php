...
if (isset($_REQUEST['act']) && ($_REQUEST['act'] == 'detail_query' || $_REQUEST['act'] == 'download')) {
    ...
    if ($_REQUEST['act'] == 'download') {
		...
		$file_name = $_LANG['store_integral_detail'];
        ...
        /* 文件标题 */
        echo ecs_iconv(EC_CHARSET, 'GB2312', $_LANG['store_integral_detail']) . "\t\n";

        /* 商品名称,订单号,商品数量,销售价格,销售日期 */
        echo ecs_iconv(EC_CHARSET, 'GB2312', $_LANG['goods_steps_name']) . "\t";
        echo ecs_iconv(EC_CHARSET, 'GB2312', $_LANG['gift_consumption_score']) . "\t";
        echo ecs_iconv(EC_CHARSET, 'GB2312', $_LANG['gift_grade_integral']) . "\t\n";
...
if (isset($_REQUEST['act']) && ($_REQUEST['act'] == 'order_query' || $_REQUEST['act'] == 'order_download')) {
    ...
    if ($_REQUEST['act'] == 'order_download') {
        ...
        /* 文件标题 */
        echo ecs_iconv(EC_CHARSET, 'GB2312', $_LANG['give_integral_order_list']) . "\t\n";

        /* 商品名称,订单号,商品数量,销售价格,销售日期 */
        echo ecs_iconv(EC_CHARSET, 'GB2312', $_LANG['order_sn']) . "\t";
		echo ecs_iconv(EC_CHARSET, 'GB2312', $_LANG['goods_steps_name']) . "\t";
		echo ecs_iconv(EC_CHARSET, 'GB2312', $_LANG['goods_number']) . "\t";
        echo ecs_iconv(EC_CHARSET, 'GB2312', $_LANG['give_integral']) . "\t";
        echo ecs_iconv(EC_CHARSET, 'GB2312', $_LANG['rank_integral']) . "\t\n";

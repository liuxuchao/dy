...
if ($_REQUEST['act'] == 'single_check')
{
    ...
    if ($_REQUEST['check'] == 'allow')
    {
            ...
            if($integ)
            {
                    log_account_change($user_id, $user_money = 0, $frozen_money = 0, $rank_points = 0, $pay_points = $integ, $change_desc = $_LANG['single_reward']);
            }
    ...
    else
    {
            ...
            {
                    log_account_change($user_id, $user_money = 0, $frozen_money = 0, $rank_points = 0, $pay_points = -$integ, $change_desc = $_LANG['single_prohibit_integral']);
            }

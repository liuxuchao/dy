...
if (file_exists(MOBILE_BARGAIN)) {
  $modules['02_promotion']['19_bargain'] = '../mobile/index.php?r=bargain/admin/index';   //砍价
}

//ecmoban模板堂 --zhuo start
$modules['02_promotion']['gift_gard_list']       = 'gift_gard.php?act=list';
//$modules['02_promotion']['take_list']       = 'gift_gard.php?act=take_list';已合并到礼品卡列表内
//ecmoban模板堂 --zhuo end
...
/*统计*/
//$modules['06_stats']['flow_stats']                  = 'flow_stats.php?act=view';          //浏览分析
//$modules['06_stats']['searchengine_stats']          = 'searchengine_stats.php?act=view';  //搜索引擎
//$modules['06_stats']['z_clicks_stats']              = 'adsense.php?act=list';             //站外投放JS
$modules['06_stats']['report_guest']                = 'guest_stats.php?act=list';           //客户统计
$modules['06_stats']['report_order']                = 'order_stats.php?act=list';           //订单统计
//$modules['06_stats']['report_sell']                 = 'sale_general.php?act=list';        //销售概况
$modules['06_stats']['sale_list']                   = 'sale_list.php?act=list';             //销售明细
//$modules['06_stats']['sell_stats']                  = 'sale_order.php?act=goods_num';     //销售排行
...
//$modules['31_fund']['03_recharge_management']       	= 'fund_stats.php?act=recharge_management';
//$modules['31_fund']['04_cash_management']          	= 'fund_stats.php?act=cash_management';
...
$modules['24_sms']['dscsms_configure']                = 'dscsms_configure.php?act=list';          // 互亿
/* 短信 end */
...
if (file_exists(MOBILE_WECHAT)) {
    ...
    //$modules['22_wechat']['30_wxapp_config'] = '../mobile/index.php?m=wechat&c=wxapp';
...
$menu_top['suppliers'] = '18_suppliers,19_suppliers_goods,20_suppliers_promotion,21_suppliers_order,22_suppliers_stats';//供应商
$menu_top['finance'] = '06_stats,31_fund,32_bill';//财务

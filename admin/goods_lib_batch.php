 ...
 * ============================================================================
 * $Author: liu $
 * $Id: goods_lib_batch.php 17217 2017-07-19 17:11:08Z liu $
 */
...
elseif ($_REQUEST['act'] == 'upload')
{
    ...
    $arr = array();
    $goods_list = array();
    $field_list = array_keys($_LANG['upload_goods_lib']); // 字段列表
        ...
        foreach ($_POST['checked'] AS $key => $value)
        {
            ...
            foreach ($field_list AS $field)
            {
                ...
                if (!empty($field_value))
                {
                    ...
                    // bool型
                    elseif (in_array($field, array( 'is_on_sale', 'is_real')))
                    {
...
{
    //$filter = &new stdclass;
	$filter = new stdclass; //ecmoban模板堂 --zhuo

...
{
	$smarty->assign('menu_select',array('action' => '19_merchants_store', 'current' => '05_merchants_shop_bg'));
    ...
    $smarty->assign('ur_here',$_LANG['set_store_bg']);
...
elseif ($_REQUEST['act'] == 'second')
{
    ...
    if ($data_op == 'add') {
        ...
        sys_msg($_LANG['edit_store_bg_success'], 0, $lnk);
    } else {

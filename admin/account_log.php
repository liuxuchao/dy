...
if ($_REQUEST['act'] == 'list') {
    ...
    if ($user_id > 0) {
        $smarty->assign('action_link2', array('href' => 'users.php?act=list', 'text' => $_LANG['user_list']));
    }
...
elseif ($_REQUEST['act'] == 'add') {
	...
	if ($user_id > 0) {
        $smarty->assign('action_link', array('href' => 'users.php?act=list&user_id=' . $user_id, 'text' => $_LANG['user_list']));
    }

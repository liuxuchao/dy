...
if ($_REQUEST['act'] == 'add') {
    ...
    if ($goods_id > 0) {
        $smarty->assign('action_link', array('text' => $_LANG['back_goods_qua_desc'], 'href' => 'goods.php?act=product_list&goods_id=' . $goods_id));
    }
    ...
    if (isset($_SESSION['goods_list']) && $_SESSION['goods_list']) {
        ...
        if (!empty($result['list']['goods_attr'])) {
            ...
            if ($product_id) {
                ...
                $result['status_lang'] = '<span style="color: red;">'.$_LANG['upload_date_success'].'</span>';
            } else {
                ...
                if($product_id){
                    $result['status_lang'] = '<span style="color: red;">'.$_LANG['add_date_success'].'</span>';
                }else{
                    $result['status_lang'] = '<span style="color: red;">'.$_LANG['add_date_fail'].'</span>';
                }
            }
        }
    }

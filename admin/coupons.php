    ...
    if (isset($_POST['type']))
    {
        ...
        elseif ($_POST['type'] == 'review_to')
        {
            ...
            if($db->query($sql))
            {
                ...
                sys_msg($_LANG['coupons_adopt_status_set_success'], 0, $lnk);
            }
        }
    }
}
...
{	
    ...
    {
        $row['cou_type'] = $row['cou_type']==1? $GLOBALS['_LANG']['coupons_type_01'] :($row['cou_type']==2? $GLOBALS['_LANG']['coupons_type_02'] :($row['cou_type']==3? $GLOBALS['_LANG']['coupons_type_03'] :($row['cou_type']==4? $GLOBALS['_LANG']['coupons_type_04'] :'')));
        ...
        $row['cou_is_use'] = $row['cou_is_use']==0?$_LANG['no_use']:'<span style=color:red;>'.$GLOBALS['_LANG']['already_used'].'</span>';
        $row['cou_is_time'] = $row['cou_is_time']==0?$_LANG['no_overdue']:'<span style=color:red;>'.$GLOBALS['_LANG']['expired'].'</span>';

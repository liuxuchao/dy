...
if($shop_id < 1){
    $lnk[] = array('text' => $_LANG['set_store_info'],'href'=>'index.php?act=merchants_first');
...
if ($_REQUEST['act'] == 'install')
{
    ...
    $sql = "UPDATE " .$GLOBALS['ecs']->table('seller_shopinfo'). " SET seller_theme = '$tpl_name', store_style = '$tpl_fg', win_goods_type = '" .$template_info['win_goods_type']. "'" .
    ...
    if ($step_install)
    {
        ...
        $error_msg = '';
        make_json_result(read_style_and_tpl($tpl_name, $tpl_fg), $_LANG['template_install_success']);
    }
    else
    {

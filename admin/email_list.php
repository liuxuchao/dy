...
{
	$smarty->assign('action_link', array('text' => $_LANG['export'], 'href' => 'email_list.php?act=export'));
    $emaildb = get_email_list();
    $smarty->assign('full_page',    1);
    $smarty->assign('ur_here', $_LANG['03_email_list']);
...
elseif ($_REQUEST['act'] == 'query')
{
    ...
    make_json_result($smarty->fetch('email_list.dwt'), '',

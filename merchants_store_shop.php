...
if (!$smarty->is_cached('merchants_shop.dwt', $cache_id))
{
    ...
    $goods_list = get_shop_goods_cmt_list($merchant_id, $region_id, $area_id, $area_city, $price_min, $price_max, $page, $size, $sort, $order);
    ...
    $store_best_list = get_shop_goods_count_list(0, $region_id, $area_id, $area_city, 1, 'store_best', 0, $limit);

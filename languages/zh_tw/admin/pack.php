...
$_LANG['pack_img'] = '包裝圖紙';
$_LANG['pack_desc'] = '包裝描述';

$_LANG['pack_edit'] = '編輯包裝';

$_LANG['drop_pack_img'] = '刪除包裝圖紙';
$_LANG['confirm_pack_img'] = '你確認要刪除賀卡圖紙嗎？';
$_LANG['drop_pack_img_success'] = '刪除包裝圖片成功';

$_LANG['pack_edit_lnk'] = '重新編輯該包裝';
$_LANG['pack_list_lnk'] = '返回列表頁面';

/*幫助信息*/
$_LANG['notice_packfee'] = '使用這個包裝所需要支付的費用，免費時設置為0';
$_LANG['notice_freemoney'] = '當用戶消費金額超過這個值時，將免費使用這個包裝。<br /> 設置為0時表明必須支付包裝費用';

...
$_LANG['package_adopt_status_set_success'] = '超值礼包审核状态设置成功';
...
$_LANG['goods_number_notic_one'] = '商品数量必须大于0且必须为数字';
$_LANG['goods_number_notic_two'] = '此商品属性已存在，请重新选择！';

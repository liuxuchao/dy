...
$_LANG['log_action']['apply_sn'] = '商家等级申请';//by kong 
...
$_LANG['log_action']['users_real'] = '实名认证用户'; // 实名认证 qin

$_LANG['log_action']['admin_login'] = '管理员登陆'; //管理员登陆

$_LANG['log_action']['goods_transport'] = '商品运费模板'; //运费模板

...
$_LANG['select_position_id'] = '选择广告位置';
$_LANG['advance_date_position'] = '即将到期广告';
$_LANG['end_position'] = '已结束广告';

$_LANG['ads_name_xlh'] = '广告名称序号';
$_LANG['ads_select_cat_id'] = '选择广告分类ID';
$_LANG['ads_shuru_cat_id'] = '请输入分类ID';
...
$_LANG['upfile_bg_img'] = '上传广告背景图片';
$_LANG['upfile_brand_img'] = '上传品牌商标图片';
$_LANG['b_title'] = '广告大标题';
$_LANG['s_title'] = '广告小标题';
$_LANG['img_url'] = '或图片网址';
...
$_LANG['js_languages']['ad_id_min_1'] = '广告序号最小为1';
...
/*大商创1.5新增*/
$_LANG['keyword'] = '关键词';
$_LANG['home_rec_mer_pro'] = '首页推荐商家商品';
$_LANG['new_adv'] = '最新广告';
$_LANG['hot_adv'] = '热门广告';
$_LANG['best_adv'] = '精品广告';
...
/*手机后台广告 语言包*/
$_LANG['ads_channel'] = '广告频道';
$_LANG['select_ads_channel'] = '请选择一级频道';
$_LANG['ads_type'] = '广告方位';
$_LANG['select_ads_type'] = '请选择广告方位';
$_LANG['top'] = '顶部';
$_LANG['right'] = '右边';
$_LANG['left'] = '左边';
$_LANG['bottom'] = '底部';
$_LANG['ads_belong'] = '广告位所属模块';
$_LANG['select_belong_type'] = '请选择所属模块';
$_LANG['seckill'] = '秒杀';
$_LANG['wxapp'] = '小程序';
...
/* 页面顶部操作提示 */
$_LANG['operation_prompt_content']['list'][0] = '展示网站页面所有的广告位置。';
$_LANG['operation_prompt_content']['list'][1] = '点击查看可查看广告位置相关广告位的广告。';
$_LANG['operation_prompt_content']['list'][2] = '可搜索广告名关键词进行查询。';

$_LANG['operation_prompt_content']['info'][0] = '请设置合适的广告位名称和图片尺寸。';
$_LANG['operation_prompt_content']['info'][1] = '步骤：添加广告位-添加广告信息-设置模板，每一步都不用返回，直接按提示一步步进行。';
$_LANG['operation_prompt_content']['info'][2] = '手机端广告位不限宽度与高度';

$_LANG['operation_prompt_content']['adv_info'][0] = '上传广告图片时请注意图片尺寸问题。';

$_LANG['operation_prompt_content']['adv_list'][1] = '该页面展示了商城所有的广告。';
$_LANG['operation_prompt_content']['adv_list'][1] = '可搜索广告名称关键词进行查询，侧边栏可进行高级搜索。';

// 商家后台
$_LANG['label_ad_name_id'] = '广告名称序号：';
$_LANG['label_select_cate_ad_id'] = '选择广告分类ID：';
$_LANG['please_input_cate_id'] = '请输入分类ID';

...
/* 页面顶部操作提示 */
$_LANG['operation_prompt_content']['info'][0] = '该页面展示商城所有功能权限。';
$_LANG['operation_prompt_content']['info'][1] = '打钩即是分配权限，请谨慎操作。';

$_LANG['operation_prompt_content']['list'][0] = '该页面展示了所有角色信息列表。';
$_LANG['operation_prompt_content']['list'][1] = '角色为管理员下级的管理角色统称。';
$_LANG['operation_prompt_content']['list'][2] = '角可以输入用户名名称关键字进行搜索，侧边栏可进行高级搜索。';
?>
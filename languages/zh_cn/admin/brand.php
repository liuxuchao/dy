...
$_LANG['brand_separate'] = '统一使用平台品牌ID';

$_LANG['brand'] = '品牌';
$_LANG['brand_name'] = '品牌名称';
$_LANG['brand_img'] = '品牌图片';
$_LANG['site_url'] = '品牌网址';
$_LANG['brand_desc'] = '品牌描述';
$_LANG['brand_logo'] = '品牌LOGO';
$_LANG['index_img'] = '品牌专区大图';
$_LANG['brand_bg'] = '品牌背景图';
$_LANG['sort_order'] = '排序';
$_LANG['is_show'] = '是否显示';
...
$_LANG['brand_first_char'] = '品牌首字母';
$_LANG['generate_brand_first_char'] = '生成品牌首字母';

$_LANG['brand_edit_lnk'] = '重新编辑该品牌';
$_LANG['brand_list_lnk'] = '返回列表页面';
$_LANG['update_data_success'] = '已更新数据成功';
$_LANG['update_data_fail'] = '已更新数据失败';

/*帮助信息*/
$_LANG['up_brandlogo'] = '请上传图片，做为品牌的LOGO！标准尺寸200*88';
$_LANG['warn_brandlogo'] = '你已经上传过图片。再次上传时将覆盖原图片！标准尺寸200*88';
$_LANG['brand_first_char_desc'] = '用于解决某些生僻字无法正确生成品牌首字母的情况。';
$_LANG['index_img_desc'] = '标准尺寸278*285';
$_LANG['brand_bg_desc'] = '使用于品牌详情页头部分类背景，建议尺寸：1920*200';
...
$_LANG['current_update_number'] = '当前更新商品数量';
/*JS 语言项*/
$_LANG['js_languages']['no_brandname'] = '您必须输入品牌名称！';
$_LANG['js_languages']['no_brandletter'] = '您必须输入品牌英文名称！';
...
/* 页面顶部操作提示 */
$_LANG['operation_prompt_content']['create_brand_letter'][0] = '生成品牌的首字母，主要用于后台的品牌搜索按首字母查询';

$_LANG['operation_prompt_content']['list'][0] = '展示了商城自营品牌的相关信息。';
$_LANG['operation_prompt_content']['list'][1] = '可以通过品牌关键字搜索相关品牌信息。';

$_LANG['operation_prompt_content']['info'][0] = '请按提示文案填写信息，以免出错。';

$_LANG['operation_prompt_content']['separate'][0] = '操作商家商品品牌统一使用平台品牌ID，请耐心等待数据执行完毕。';
?>

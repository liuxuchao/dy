...
$_LANG['sitemaps_note'] = 'Sitemaps 服务旨在使用 Feed 文件 sitemap.xml 通知 Google、Yahoo! 以及 Microsoft 等 Crawler(爬虫)网站上<br />哪些文件需要索引、这些文件的最后修订时间、更改频度、文件位置、相对优先索引权，这些信息将帮助他们建立索引范围和索引的行为习惯。详细信息请查看 <a href="http://www.sitemaps.org/" target="_blank">sitemaps.org</a> 网站上的说明。';

/* 教程名称 */
$_LANG['tutorials_bonus_list_one'] = '商城站点地图说明';

/* 页面顶部操作提示 */
$_LANG['operation_prompt_content'][0] = '设置站点地图更新频率和时间。';
$_LANG['operation_prompt_content'][1] = '网站地图中定义的更新时间是能够让蜘蛛规律性的来爬取整个网站，检查网站有没有更新的文章或者帖子。';
?>
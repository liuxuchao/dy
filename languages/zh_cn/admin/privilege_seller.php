...
$_LANG['operation_prompt_content']['list'][0] = '该页面展示了所有入驻平台的商家管理员列表。';
$_LANG['operation_prompt_content']['list'][1] = '可手动添加管理员并分配权限、查看日志等操作。';
$_LANG['operation_prompt_content']['list'][2] = '可以输入用户名名称关键字进行搜索，侧边栏可进行高级搜索。';

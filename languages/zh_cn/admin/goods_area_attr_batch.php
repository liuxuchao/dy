...
// 批量上传商品的字段
$_LANG['upload_area_attr']['goods_id'] = '商品编号';
$_LANG['upload_area_attr']['goods_name'] = '商品名称';
$_LANG['upload_area_attr']['shop_name'] = '商家名称';
$_LANG['upload_area_attr']['seller_id'] = '商家ID';
$_LANG['upload_area_attr']['region_name'] = '地区名称';
$_LANG['upload_area_attr']['attr_name'] = '属性名称';
$_LANG['upload_area_attr']['attr_price'] = '属性价格';
$_LANG['upload_area_attr']['state'] = '状态';

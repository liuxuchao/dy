...
/* 页面顶部操作提示 */
$_LANG['operation_prompt_content']['info'][0] = '上传广告图片时请注意图片尺寸问题。';

$_LANG['operation_prompt_content']['list'][0] = '该页面展示了手机网站页面所有的广告。';
$_LANG['operation_prompt_content']['list'][1] = '可搜索广告名称关键词进行查询。';

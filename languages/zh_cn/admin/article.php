...
$_LANG['upload_file_notic'] = '图片尺寸280*160';
...
$_LANG['not_min_cat'] ='存在下级分类，无法在该分类下添加/编辑文章';
...
$_LANG['all_cat'] = '全部分类';
$_LANG['article_news'] = 'News装修';

$_LANG['back_edit_article_content'] = '返回编辑文章内容';
$_LANG['delete_upload_file_success'] = '删除上传文件成功！';

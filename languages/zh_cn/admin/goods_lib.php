...
$_LANG['goods_lib_list'] = '商品库列表';

$_LANG['img_import_fail'] = '图片导入失败';
$_LANG['prompt_import_success'] = '导入成功';
$_LANG['prompt_import_fail'] = '导入失败';
$_LANG['repeat_import'] = '重复导入';
...
$_LANG['operation_prompt_content']['list'][2] = '此页数据与供应商商品同步，请谨慎操作。';
$_LANG['operation_prompt_content']['list'][3] = '供应商商品库商品是提供给商家导入此商品为普通商品销售的商品列表。';

...
$_LANG['full_backup'] ='全部备份(推荐)';
$_LANG['full_backup_note'] ='备份数据库所有表';
$_LANG['stand_backup'] ='标准备份';
...
$_LANG['unrecognize_version'] = '不能识别备份sql的大商创版本';
...
/* 页面顶部操作提示 */
$_LANG['operation_prompt_content']['backup'][0] = '请先选择备份类型。';
$_LANG['operation_prompt_content']['backup'][1] = '请谨慎设置备份，以免出错。';

$_LANG['operation_prompt_content']['restore'][0] = '该页面展示商城所有功能权限。';

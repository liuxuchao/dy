...
$_LANG['cat_grade'][1]   = '一级分类';
$_LANG['cat_grade'][2]   = '二级分类';
$_LANG['cat_grade'][3]   = '三级分类';
$_LANG['cat_grade'][4]   = '四级分类';
$_LANG['cat_grade'][5]   = '五级分类';
...
$_LANG['has_article_on_this_cat'] = '该分类下存在文章，无法添加子分类';

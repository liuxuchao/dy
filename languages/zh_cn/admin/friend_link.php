...
/* 教程名称 */
$_LANG['tutorials_bonus_list_one'] = '商城友情链接操作说明';

/* 页面顶部操作提示 */
$_LANG['operation_prompt_content']['info'][0] = '请认真填写链接名称、链接地址等信息。';

$_LANG['operation_prompt_content']['list'][0] = '该页面展示所有友情链接信息列表。';
$_LANG['operation_prompt_content']['list'][1] = '可点击链接进入相应网页，也可进行编辑或删除友情链接。';
?>
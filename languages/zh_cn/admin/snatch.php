...
$_LANG['self_info'] = '基本信息';
$_LANG['snatch_introduce'] = '夺宝介绍';
$_LANG['service_guarantee'] = '服务保障';
$_LANG['snatch_strategy'] = '夺宝攻略';
...
$_LANG['search_select_notice'] = '搜索结果在活动商品里面显示出来';
$_LANG['snatch_adopt_status_success'] = '夺宝奇兵审核状态设置成功';

/* 帮助信息 */
$_LANG['notice_goodsid'] = '需要先搜索商品，生成商品列表，然后再选择';
$_LANG['notice_min_price'] = '用户出价范围的下限';
$_LANG['notice_max_price'] = '用户出价范围的上限';
$_LANG['notice_min_max_price'] = '用户出价范围的上下限';
...
$_LANG['js_languages']['invalid_price'] = '输入的价格上限应大于价格下限。';
$_LANG['js_languages']['search_is_null'] = '没有搜索到任何商品，请重新搜索';

/* 批量删除 */
$_LANG['js_languages']['batch_drop_confirm'] = '您确定要删除选定的活动吗？';
$_LANG['batch_drop_success'] = '成功删除了 %s 条活动记录。';
$_LANG['no_select_snatch'] = '您现在没有夺宝活动记录！';

/* 教程名称 */
$_LANG['tutorials_bonus_list_one'] = '商城夺宝奇兵活动说明';

/* 页面顶部操作提示 */
$_LANG['operation_prompt_content']['list'][0] = '列表页可查看该活动信息字段，如活动名称、商家名称、活动开始时间、活动结束时间、价格下限等，可进行搜索、增删改查功能。';
$_LANG['operation_prompt_content']['list'][1] = '根据活动名称、店铺名称等条件搜索出具体活动相关信息。';

$_LANG['operation_prompt_content']['view'][0] = '展示活动出价用户、出价价格等信息。';
$_LANG['operation_prompt_content']['view'][1] = '出价记录管理。';


$_LANG['label_up_down_limit_price'] = '价格上下线：';
$_LANG['notice_up_down_limit_price'] = '用户出价范围的上下限';
$_LANG['label_max_pay'] = '最多需支付的价格：';
$_LANG['notice_max_pay'] = '获奖者出价高于这个价格，则以这个价格购买该商品。为0时按用户出价购买商品';
$_LANG['label_cost_score'] = '消耗积分：';

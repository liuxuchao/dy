...
$_LANG['cat_id'] = '编号';
$_LANG['cat_name'] = '分类名称';
$_LANG['cat_name_alias'] = '分类别名';
$_LANG['cat_name_parent'] = '父级分类名称';
$_LANG['current_store_cat_level'] = '当前店铺分类级别';
$_LANG['isleaf'] = '不允许';
$_LANG['noleaf'] = '允许';
$_LANG['keywords'] = '关键字';
$_LANG['cat_desc'] = '分类描述';
...
$_LANG['top_category_mode'] = '顶级分类页模板';
$_LANG['top_category_mode_0'] = '默认模板';
$_LANG['top_category_mode_1'] = '女装模板';
$_LANG['top_category_mode_2'] = '家电模板';
$_LANG['top_category_mode_3'] = '食品模板';
$_LANG['category_icon'] = '分类菜单图标';
$_LANG['category_top_mode_content'] = '分类树顶级分类模块内容';
$_LANG['level'] = '级';
$_LANG['level_alt'] = '级别';
...
$_LANG['sel_goods_type_cat'] = '请选择属性分类';
...
$_LANG['cat_name_alias_notic'] = '（注：分类名过长设置别名方便显示，字数设置为2-4个汉字字符）';
$_LANG['phone_icon_notic'] = '（注：手机端专用,建议上传正方形图片（100*100））';
$_LANG['parent_id_notic'] = '不选择分类默认为顶级分类';
$_LANG['commission_rate_notic'] = '（请输入0-100以内的整数）';
$_LANG['category_icon_notic'] = '图标尺寸为18*18比例，大小不能超过200KB，图片只能为jpg、png、gif格式';
$_LANG['category_top_mode_content_notic'] = '(格式：名称+"英文竖线"+链接地址)，每行一条数据。';
...
$_LANG['icon']['liangyoufushi1'] = '粮油副食1';
$_LANG['icon']['weizhi'] = '位置';
$_LANG['icon']['jucha2'] = '聚茶2';
$_LANG['icon']['jinkou'] = '进口';
$_LANG['icon']['shuiguo'] = '水果';
$_LANG['icon']['jiubei'] = '酒杯';

/* 页面顶部操作提示 */
$_LANG['operation_prompt_content']['list'][0] = '展示了平台所有的商品分类。';
$_LANG['operation_prompt_content']['list'][1] = '可在列表直接增加下一级分类。';
$_LANG['operation_prompt_content']['list'][2] = '可在商品分类列表进行转移分类下的商品。';
$_LANG['operation_prompt_content']['list'][3] = '鼠标移动“设置”位置，可新增下一级分类、查看下一级分类、转移商品等操作。';

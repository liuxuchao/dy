...
$_LANG['js_languages']['select_remove_cat'] = '请选择删除分类';
$_LANG['js_languages']['select_cat_add'] = '请先选择分类，如果没有分类先添加分类';
$_LANG['js_languages']['jl_upload_banner_img'] = '请上传banner图';
$_LANG['js_languages']['jl_add_topic_cat'] = '请先添加专题分类';

...
$_LANG['input_sn'] = '输入商品货号(每行只能输入一个货号)';
...
$_LANG['upload_goods_lib']['brand_name'] = '商品品牌';   // 需要转换成brand_id
...
$_LANG['operation_prompt_content']['select'][0] = '根据分类、品牌或者货号搜索商品，在选择的商品列表中选中需要批量编辑的商品。';
$_LANG['operation_prompt_content']['select'][1] = '选择逐个编辑或是统一编辑，点击进入编辑开始编辑。';
$_LANG['operation_prompt_content']['select'][2] = '逐个编辑可在选中商品编辑列表进行编辑，如修改市场价格、本地价格、赠送积分、库存等信息。';
$_LANG['operation_prompt_content']['select'][3] = '统一编辑是选中需要统一信息的商品进行编辑。';

$_LANG['operation_prompt_content']['edit'][0] = '可从管理平台手动添加一名新会员，并填写相关信息。';
$_LANG['operation_prompt_content']['edit'][1] = '新增会员后可从会员列表中找到该条数据，并再次进行编辑操作，但该会员名称不可变。';

...
$_LANG['auction_audited_set_ok'] = '拍卖活动审核状态设置成功';
...
$_LANG['js_languages']['good_name_not_null'] = '请选择商品';
$_LANG['js_languages']['start_price_not_null'] = '请输入起拍价';
$_LANG['js_languages']['amplitude_not_null'] = '请输入加价幅度';
...
$_LANG['label_start_end_time'] = '拍卖起止时间：';
$_LANG['basic_info'] = '基本信息';
$_LANG['auction_desc'] = '拍卖介绍';
$_LANG['promise'] = '服务保障';
$_LANG['ensure'] = '竞拍攻略';

$_LANG['auction_explain'] = '商城拍卖活动说明';

/* 页面顶部操作提示 */
$_LANG['operation_prompt_content'][0] = '列表页可根据条件，如商品名称、店铺名称等搜索出具体参加拍卖活动的商品活动信息。';
$_LANG['operation_prompt_content'][1] = '列表页展示了所有的拍卖活动名称、商家名称、商品名称、起始时间等信息列表。';
$_LANG['operation_prompt_content'][2] = '可添加、查看、编辑、删除或批量删除拍卖活动操作。';

$_LANG['operation_prompt_content'][3] = '该页面展示了拍卖活动的出价记录。';
$_LANG['operation_prompt_content'][4] = '主要展示了买家、出价、时间、状态的信息列表。';

...
$_LANG['notice_run_once'] = '勾选后即不能再执行计划任务，默认不勾选即可循环执行';
$_LANG['cron_do'] = '执行';
$_LANG['do_ok'] = '执行成功';
$_LANG['cron_month'] = '每月';
$_LANG['cron_day'] = '日';
...
/* 教程名称 */
$_LANG['tutorials_bonus_list_one'] = '商城计划任务操作说明';

/* 页面顶部操作提示 */
$_LANG['operation_prompt_content']['list'][0] = '展示计划任务列表、计划任务描述、版本、插件记者等信息。';
$_LANG['operation_prompt_content']['list'][1] = '可开启或关闭计划任务，计划任务可安装、卸载、编辑等操作。';
$_LANG['operation_prompt_content']['list'][2] = '计划任务执行文件 api/cron.php';

$_LANG['operation_prompt_content']['info'][0] = '对于已安装的计划任务可进行编辑，编辑计划任务名称、内容、执行时间等信息。';

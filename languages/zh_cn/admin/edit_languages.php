...
$_LANG['search_languages'] = '请先搜索语言包';
...
/* 页面顶部操作提示 */
$_LANG['operation_prompt_content']['list'][0] = '选择语言包和需要修改的关键字进行搜索。';
$_LANG['operation_prompt_content']['list'][1] = '修改语言包对应的内容。';
$_LANG['operation_prompt_content']['list'][2] = '请谨慎操作，如出现错误可还原。';

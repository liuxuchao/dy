...
$_LANG['list_link'] = '合作伙伴列表';
$_LANG['add_link'] = '添加新链接';
$_LANG['edit_link'] = '编辑合作伙伴';
$_LANG['link_name_empty'] = '合作伙伴名称不能为空！';
$_LANG['no_links'] = '您还没有添加合作伙伴';

$_LANG['back_list'] = '返回合作伙伴连接列表';
$_LANG['continue_add'] = '继续添加合作伙伴';

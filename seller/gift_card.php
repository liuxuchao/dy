...
if ($_REQUEST['act'] == 'query')
{
    ...
    make_json_result($smarty->fetch('gift_gard_list.htm'), '',
...
if ($_REQUEST['act'] == 'query_take')
{
	...
	make_json_result($smarty->fetch('take_list.htm'), '',
	array('filter' => $list['filter'], 'page_count' => $list['page_count']));
}
...
if ($_REQUEST['act'] == 'query_bonus')
{
    ...
    make_json_result($smarty->fetch('gift_list.htm'), '',
        array('filter' => $list['filter'], 'page_count' => $list['page_count']));
}

...
if ($_REQUEST['act'] == 'list')
{
    ...
    $smarty->assign('action_link',  array('text' => $_LANG['add_shop_window'], 'href' => 'merchants_custom.php?act=add', 'class' => 'icon-plus'));
...
elseif ($_REQUEST['act'] == 'add')
{
    ...
    $smarty->assign('action_link', array('text' => $_LANG['shop_windows_list'], 'href' => 'merchants_custom.php?act=list', 'class' => 'icon-reply'));

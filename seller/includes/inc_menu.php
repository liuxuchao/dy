...
if(judge_supplier_enabled()){
    $modules['19_merchants_store']['12_apply_suppliers']       = 'merchants_upgrade.php?act=suppliers_apply';  //入驻供应商
}
...
if(is_dir(MOBILE_BARGAIN)){
    $modules['02_promotion']['19_bargain'] = 'bargain.php?act=list'; //砍价
}
...
if(judge_supplier_enabled()){
	$modules['10_priv_admin']['01_suppliers_list']      = 'suppliers.php?act=list'; // 供货商
}else{

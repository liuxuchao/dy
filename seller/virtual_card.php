 ...
 * ECSHOP 虚拟卡商品管理程序
 * ============================================================================
 * * 版权所有 2012-2016 上海商创网络科技有限公司，并保留所有权利。
 ...
 * ============================================================================
 * $Author: liubo $
 * $Id: virtual_card.php 17217 2016-03-19 06:29:08Z liubo $
 */
...
if ($_REQUEST['act'] == 'replenish')
{
    ...
    $smarty->assign('action_link', array('text'=>$_LANG['go_list'], 'href'=>'virtual_card.php?act=card&goods_id='.$card['goods_id'], 'class' => 'icon-reply'));
...
$smarty->assign('ur_here',      $_LANG['virtual_card']."--".$goods_name);
    $smarty->assign('action_link',  array('text'    => $_LANG['replenish'],
                                            'href'  => 'virtual_card.php?act=replenish&goods_id='.$_REQUEST['goods_id'],'class' => 'icon-plus'));
    $smarty->assign('goods_id',      $_REQUEST['goods_id']);
...
elseif ($_REQUEST['act'] == 'query_card')
{
    ...
    make_json_result($smarty->fetch('replenish_list.dwt'), '',
...
elseif ($_REQUEST['act'] == 'batch_card_add')
{
    ...
    $smarty->assign('action_link',      array('text'=>$_LANG['virtual_card_list'], 'href'=>'goods.php?act=list&extension_code=virtual_card' , 'class' => 'icon-reply'));
    $smarty->assign('goods_id',           $_REQUEST['goods_id']);
	$smarty->assign('menu_select',array('action' => '02_cat_and_goods', 'current' => '01_goods_list'));

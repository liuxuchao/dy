    ...
    if (count($item_list) > 0) {
        ...
        foreach ($item_list as $key => $val) {
            ...
            if ($val['ru_id'] == 0) {
                ...
                $sql = "SELECT mobile, seller_email FROM " . $GLOBALS['ecs']->table('seller_shopinfo') . " WHERE ru_id = '" . $val['ru_id'] . "'";
                ...
                $shop_name = get_shop_name($val['ru_id'], 1);
            }
            ...
            //给商家发邮件
            if ($_CFG['send_service_email'] == '1' && $service_email != '' && $val['item_type'] == 2) {
                //获取订单商品信息

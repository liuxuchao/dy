...
class wxpay
{
    ...
    function get_code($order, $payment)
    {
        ...
        elseif($result["code_url"] != NULL)
        {
			...
			$filename = $tmp . md5($code_url . $errorCorrectionLevel . $matrixPointSize) . '.png';
			...
			$wxpay_lbi = '<div id="wxpay_dialog" class="hide">' .
							'<div class="modal-box">' .
								'<div class="modal-left">' .
									...
									'<div class="modal-qr">' .
										'<div class="modal-qrcode"><img src="'.$GLOBALS['ecs']->url(). 'images/qrcode/'.basename($filename).'?t='.time().'" /></div>' .

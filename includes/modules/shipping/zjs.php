...
$shipping_lang = ROOT_PATH.'languages/' .$GLOBALS['_CFG']['lang']. '/shipping/zjs.php';
...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 打印单背景 */
    $modules[$i]['print_bg'] = '/images/receipt/dly_zjs.jpg';
   ...
   /* 打印快递单标签位置信息 */
    ...
    /* 快递编码 */
    $modules[$i]['kdniao_code'] = "ZJS";	

    /* 快递鸟打印尺寸-宽度 */
    $modules[$i]['kdniao_width'] = 100;	

    /* 快递鸟打印尺寸-高度 */
    $modules[$i]['kdniao_height'] = 116;		
...
class zjs
{
    ...
    function query($invoice_sn)
    {
        $str = '<form style="margin:0px" methods="post" '.
            'action="http://www.zjs.com.cn/api/tracking.jspx" name="queryForm_' .$invoice_sn. '" target="_blank">'.
            '<input type="hidden" name="orderNos" value="' .$invoice_sn. '" />'.

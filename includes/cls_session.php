...
class cls_session
{
    ...
    function gen_session_key($session_id)
    {
        ...
        return sprintf('%08x', crc32(strtolower(ROOT_PATH) . $ip . $session_id));
    }

    function insert_session()
    {
		if($this->db->query('INSERT INTO ' . $this->session_table . " (sesskey, expiry, ip, data) VALUES ('" . $this->session_id . "', '". $this->_time ."', '". $this->_ip ."', 'a:0:{}')")){
			return true;			
		}else{
		   $this->db->query(" TRUNCATE ". $this->session_table);		

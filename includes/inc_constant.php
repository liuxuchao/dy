...
define('MOBILE_WECHAT',             ROOT_PATH . 'mobile/app/Modules/Wechat'); //微商城目录
define('MOBILE_DRP',                ROOT_PATH . 'mobile/app/Modules/Drp'); //微分销目录
define('MOBILE_TEAM',               ROOT_PATH . 'mobile/app/Modules/Team'); //拼团目录
define('MOBILE_BARGAIN',            ROOT_PATH . 'mobile/app/Modules/Bargain'); //砍价目录
define('MOBILE_KEFU',               ROOT_PATH . 'kefu'); //拼团目录
...
define('PAY_APPLYGRADE',            2); // 商家升级付款  
define('PAY_TOPUP',                 3); // 商家账户充值
define('PAY_APPLYTEMP',             4); // 商家购买模板付款  

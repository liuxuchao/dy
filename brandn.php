...
if ($act == 'index')
{
    $smarty->assign('best_goods', brand_recommend_goods('best', $brand_id, $cate, $region_id, $area_id, $area_city, $act)); // 精品
...
{
    $smarty->assign('best_goods', brand_recommend_goods('best', $brand_id, $cate, $region_id, $area_id, $area_city, $act)); // 精品
    $smarty->assign('hot_goods', brand_recommend_goods('hot', $brand_id, $cate, $region_id, $area_id, $area_city, $act)); //热卖
    $smarty->assign('new_goods', brand_recommend_goods('new', $brand_id, $cate, $region_id, $area_id, $area_city, $act)); //新品
	
    $goodslist = brand_get_goods($brand_id, $cate, $size, $page, $sort, $order, $region_id, $area_id, $area_city, $act, $is_ship, $price_min, $price_max, $is_self); //by wang

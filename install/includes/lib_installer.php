...
function get_system_info()
{
    ...
    $file_types = array(
            'dwt' => ROOT_PATH . 'themes/ecmoban_dsc/index.dwt',
            'lbi' => ROOT_PATH . 'themes/ecmoban_dsc/library/member_info.lbi',
...
function install_data($sql_files)
{
    ...
    $se = new sql_executor($db, EC_DB_CHARSET, 'dsc_', $prefix);
...
function deal_aftermath()
{
    ...
    include_once(ROOT_PATH . 'includes/cls_mysql.php');
    include_once(ROOT_PATH . 'includes/cls_ecmac.php');//获取mac地址
...
function get_web_info()
{
	$web_info=array(
		'sc_version'=>VERSION,
		'user_domain'=>get_domain(),
		'user_ip'=>$_SERVER['SERVER_ADDR'],
		'user_os'=>PHP_OS,
		'user_webserver'=>$_SERVER['SERVER_SOFTWARE'],

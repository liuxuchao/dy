...
$_LANG['copyright'] = '&copy; 2005-2017 <a href="http://www.ecmoban.com" target="_blank">上海商创网络科技有限公司</a>。保留所有权利。';


/* 欢迎页 */
$_LANG['welcome_title'] = '欢迎您选用大商创2.0网上商店管理系统！';
...
/* 环境检测页 */
$_LANG['checking_title'] = '大商创2.0安装程序 第2步/共3步 环境检测';
...
/* 系统设置 */
$_LANG['setup'] = '填写完毕';
$_LANG['setting_title'] = '大商创2.0安装程序 第3步/共3步 配置系统';
...
$_LANG['mobile_code_explain'] = '在不改变手机安装的电脑的情况下,该验证码可重复使用';
...
$_LANG['current_version_lang'] = '当前版本仅支持简体中文';
...
$_LANG['pwd_middle'] = '中';
$_LANG['pwd_high'] = '强';
$_LANG['mobile_check'] = '手机验证';
$_LANG['mobile_num'] = '手机号：';
$_LANG['send_mobile_code'] = '发送验证码';
$_LANG['mobile_check_code'] = '验证码：';

/* 提示信息 */
$_LANG['has_locked_installer'] = '<a style="text-decoration:none; font-size:14px;">安装程序已经被锁定。</a><br /><a style="text-decoration:none; font-size:14px;">如果您确定要重新安装 <font style="color:#ec5150;">大商创2.0</font>，请删除data目录下的 <font style="color:#ec5150;">install.lock.php</font>。</a>';
...
$_LANG['open_installlock_failed'] = '打开install.lock.php文件失败';
$_LANG['write_installlock_failed'] = '写入install.lock.php文件失败';

$_LANG['install_done_title'] = '大商创2.0 安装程序 安装成功';
$_LANG['install_error_title'] = '大商创2.0 安装程序 安装失败';
$_LANG['done'] = '基于安全的考虑，请在安装完成后删除 <em>install</em> 目录。';
$_LANG['go_to_view_my_sc'] = '前往 大商创2.0 首页';
$_LANG['go_to_view_control_panel'] = '前往 大商创2.0 后台管理中心';
...
$_LANG['js_languages']['emptymobile'] = '手机号码不能为空';//by wang
$_LANG['js_languages']['emptymobile_code'] = '手机验证码不能为空';
$_LANG['js_languages']['mobile_error'] = '手机号不正确';
$_LANG['js_languages']['send_code_ok'] = '验证码已发送到手机';//by wang
$_LANG['js_languages']['send_code_error'] = '验证码发送失败,多次发送失败,请联系021-62601332';

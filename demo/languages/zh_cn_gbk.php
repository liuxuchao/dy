...
$_LANG['copyright']                     = '&copy; 2005-2011 <a href="http://www.ecmoban.com" target="_blank">上海商创网络科技有限公司</a>。保留所有权利。';
$_LANG['is_last_version']             = '您的大商创已是最新版本，无需升级。';

$_LANG['readme_page']                =  '说明页';
$_LANG['notice'] = '本程序将用于安装大商创的测试数据，请务必确认以下问题。';
...
$_LANG['upgrade_error_title']                    = '大商创测试数据安装程序 测试数据安装失败';
$_LANG['upgrade_done_title'] = '大商创测试数据安装程序 测试数据安装成功';
...
$_LANG['js_languages']['is_last_version']                   = '您的大商创已是最新版本，无需升级。';
...
$_LANG['ucenter_not_match'] = '<span style="color:#F00;font-size:1.2em;"><b>UCenter与大商创字符编码不匹配，升级不能完成，请联系管理员！</b></span>';

/* 语言字符集选择 */
$_LANG['lang_title'] = '大商创语言编码';
...
$_LANG['lang_desc']['desc1'] = '请确认您的大商创程序与您选择的语言编码一致；';
$_LANG['lang_desc']['desc2'] = '如果您的数据库与大商创程序编码不一致，可以先进行数据库编码转换。';
//$_LANG['lang_desc']['desc3'] = '<font color="red">如果您是从大商创 v2.6.0版本进行升级，并选择大商创接口方式，请先进行会员数据的导入，否则原会员将无法登录。</font>';

/* 用户接口插件语言项 */
$_LANG['ui_title'] = '请选择大商创使用的用户接口插件';
$_LANG['ui_ecshop'] = '大商创方式';
